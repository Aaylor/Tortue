...
public class Fenetre extends JFrame{
	JPanel conteneur = new JPanel(); //JPanel qui va contenir l'ensemble des �l�ments du programe
	...
	Fenetre(){
		...
		this.setLayout(new BorderLayout());//TEMPORAIRE, juste pour se faire une idée du positionnement
