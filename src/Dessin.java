...
public class Dessin extends JPanel {
	Curseur curs1 = new Curseur(20, 20, 30, 10, Color.red);
    ...
    public void paintComponent (Graphics g) {
    	...
    	double orientationRadian = curs1.convertToRadian();
    	...
    	double x2 = curs1.calculCos()*(rayon);
    	double y2 = curs1.calculSin()*(rayon);
