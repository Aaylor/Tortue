...
public class StockageDonnee
{
    ...
    public static boolean init_ldc()
    {
        ...
        liste_des_commandes.put("disablepixelart", 25);
        liste_des_commandes.put("new", 26);
        liste_des_commandes.put("open", 27);
        liste_des_commandes.put("save", 28);
        liste_des_commandes.put("saveas", 29);
        liste_des_commandes.put("savehistory", 30);
        liste_des_commandes.put("exec", 31);
        liste_des_commandes.put("repeat", 32);
        liste_des_commandes.put("clear", 33);
        liste_des_commandes.put("help", 34);
        liste_des_commandes.put("man", 35);
        liste_des_commandes.put("exit", 36);
